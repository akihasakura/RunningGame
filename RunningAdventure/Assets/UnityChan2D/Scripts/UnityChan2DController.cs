...
//	Debug.Log("highScore" + highScore);
	...
	public static  int bonuscount = 500;
...
//		GameObject.Find("Riskhedg").gameObject.collider2D.enabled = false;
    ...
    {	
		...
		{
			GameObject.Find("kumo_0").GetComponent<Renderer>().enabled  = true;
		}

		if (jumpconstraint > 70)
		{
			GameObject.Find("kumo_0").GetComponent<Renderer>().enabled  = false;
		}
...
//						life += item;
	...
	IEnumerator INTERNAL_OnInvincible()
	{
		...
		GameObject.Find("Riskhedg").gameObject.GetComponent<Collider2D>().enabled = true;
		GameObject.Find("kumo_0").GetComponent<Renderer>().enabled  = true;
    ...
    void OnFinishedInvincibleMode()
   {
		...
		GameObject.Find("Riskhedg").gameObject.GetComponent<Collider2D>().enabled = false;
		GameObject.Find("kumo_0").GetComponent<Renderer>().enabled  = false;
    }
	...
	public void GameScreen()
	{
		...
		if (gameflg != true && Input.GetMouseButtonDown (0) && GameSC == 0) 
		{
			...
			GameObject.Find("gray").GetComponent<Renderer>().enabled  = true;
			gamed = false;
			//GameObject.Find("GameEnd").guiText.text = "";
			//GameObject.Find("GameEnd2").guiText.text = "";
			//GameObject.Find("Dist").guiText.text = "";
			GameObject.Find("gameoverTxt").GetComponent<Renderer>().enabled  = false;
			GameObject.Find("Result").GetComponent<Renderer>().enabled  = false;
			GameObject.Find("score").GetComponent<GUIText>().text = "";
			GameObject.Find("ScoreBG").GetComponent<GUITexture>().enabled  = false;
			GameObject.Find("DistBG").GetComponent<GUITexture>().enabled  = false;
			GameObject.Find("Dist").GetComponent<GUIText>().text = "";
