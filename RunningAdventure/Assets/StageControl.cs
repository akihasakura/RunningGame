...
public class StageControl : MonoBehaviour {
	...
	void Start ()
	{
		...
		GameObject.Find("gray").GetComponent<Renderer>().enabled  = false;
	...
	public void gameEnd()
	{
		...
		GameObject.Find("gameoverTxt").GetComponent<Renderer>().enabled  = true;
		GameObject.Find("Result").GetComponent<Renderer>().enabled  = true;
	}
